    ...
    return (
      <div>
        <div className="leftWeather">
          ...
          <div className="Temp">Temperature: {this.props.data.main.temp}</div>
          <img className="Icon" src={`https://openweathermap.org/img/wn/${this.props.data.weather[0].icon}.png`} />
        </div>

        <div className="rightWeather">
          <div className="Pressure">Pressure: {this.props.data.main.pressure}</div>
          ...
          <div className="Wind">Wind: {this.props.data.wind.speed}, {this.props.data.wind.deg}</div>
